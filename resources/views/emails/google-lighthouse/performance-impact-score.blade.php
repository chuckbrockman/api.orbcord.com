...
$visitorsPerMonth = (int) ( isset($pageSpeedAudit->meta_data['visitors_per_month']) && !!$pageSpeedAudit->meta_data['visitors_per_month'] ? preg_replace('/[^\d.]/', '', $pageSpeedAudit->meta_data['visitors_per_month']) :  1000 );
$averageOrderValue = (int) ( isset($pageSpeedAudit->meta_data['average_order_value']) && !!$pageSpeedAudit->meta_data['average_order_value'] ? preg_replace('/[^\d.]/', '', $pageSpeedAudit->meta_data['average_order_value']) : 100 );

\Log::info('Google Pagespeed Lighthouse Score:' . $pageSpeedAudit->score);
