                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 44px 35px;font-family:Arial, Helvetica, sans-serif;" align="left">
                                                            ...
                                                            <div class="v-text-align" style="color: #131022; line-height: 180%; text-align: center; word-wrap: break-word;">
                                                                {{-- <p style="font-size: 14px; line-height: 180%;">
                                                                    <span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25.2px;">
                                                                        You're
                                                                ...
                                                                <p style="font-size: 14px; line-height: 180%;">
                                                                    <span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; line-height: 25.2px;">
                                                                        <a href="https://chuckbrockman.com" target="_blank" style="color:#131022;">Chuck Brockman</a> | <a href="https://orbcord.com" target="_blank" style="color:#131022;">Orbcord Inc.</a>
                                                                        <br>
                                                                        10801 Johnston Rd, Suite 210 Charlotte, NC, 28226
                                                                    </span>
                                                                </p>
                                                            </div>
